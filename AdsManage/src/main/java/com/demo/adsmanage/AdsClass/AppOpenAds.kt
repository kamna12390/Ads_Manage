...
object AppOpenAds {
    ...
    internal fun Context.loadAppOpenAd(
    ...
    internal fun Context.loadFirsttimeAppOpenAd(
        is_SUBSCRIBED: Boolean, mAD_AppOpenID: String, appOpenAd: Int, onSplachAds: OnSplachAds
    ) {
        if (mAD_AppOpenID == null) {
            return
        }
    ...
    internal fun Context.openAdsShow(appOpenAd: Int, onAppOpenShowAds: OnAppOpenShowAds) {
        if (appOpenAd == APP_OPEN_AD_ORIENTATION_PORTRAIT) {
            if (mAppOpenAds != null && mAppOpenAds is AppOpenAd) {
                (mAppOpenAds as AppOpenAd).fullScreenContentCallback =
            ...
            if (mAppOpenAds_LANDSCAPE != null && mAppOpenAds_LANDSCAPE is AppOpenAd) {
                (mAppOpenAds_LANDSCAPE as AppOpenAd).fullScreenContentCallback =
                    object : FullScreenContentCallback() {
                        override fun onAdDismissedFullScreenContent() {
                            mAppOpenAds_LANDSCAPE = null
                            isAdsShowing = false
